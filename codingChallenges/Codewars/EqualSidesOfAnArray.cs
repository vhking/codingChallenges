...
namespace codingChallenges.CodeWars
{
    ...
    public class EqualSidesOfAnArray
    {
        ...
        public int FindEvenIndex(int[] arr)
        {
            ...
            // compare both sides until a match is found
            for (int i = 0; i < arr.Length; ++i)
            {        
                rightSum -= arr[i];
            ...
            // returns -1 if there is no equal
            return -1;

        }


        // Best practice. And clever use of the SUM method from Linq
        public int FindEvenIndexBP(int[] arr)
        {
